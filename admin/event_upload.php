...
if(isset($_POST['submit_data'])){
    foreach($_FILES['doc']['name'] as $key=>$val){
        ...
        if($ext=='pdf'){
            ...
            $query= "INSERT INTO `event_manage` (`date`, `month`, `event_titel`, `event_desc_short`, `event_desc`, `pdf_link`, `poster_or_paper`, `time_from`, `time_to`) VALUES ('$date','$month','$event_titel','$event_short_description','$event_description','$destination_path','$type','$start_time','$end_time')";
...
<body style="overflow-x: hidden; margin-top:8%;">
    <section class="home">
  ...
  <div class="wrapper header_fixed" style="margin-top: -300px; margin-left: 60px;">
    <form action ="" method="post" enctype="multipart/form-data">
        ...
        <div class="description2">
            ...
            <button class="btn" type="submit" name="submit_data" >Add</button>
            <!-- <input type="text" name="date" id="date" inputmode="text" placeholder=" Date"> -->
        </div>
    </form>
  </div>
